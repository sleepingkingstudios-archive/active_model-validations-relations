# spec/active_model/validations/relations/serializers/underscore_serializer_spec.rb

require 'spec_helper'

require 'active_model/validations/relations/serializers/underscore_serializer'

RSpec.describe ActiveModel::Validations::Relations::Serializers::UnderscoreSerializer do
